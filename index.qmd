...
<foot_mg> Bivariate model with 95% confidence (solid) and prediction (dotted) regions. </foot_mg> 
...
<caption_mg> `r figure_ref()` Pooled sensitivity root canal filled teeth (excludes Peters 1994). </caption_mg>
