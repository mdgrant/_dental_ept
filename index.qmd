...
meta_sens_no_peters <- meta::metaprop(tp, tp + fn,
  data = root_canal,
  studlab = study,
  sm = "PLOGIT",
  method = "GLMM",
  ...
  incr = 0,
  hakn = TRUE,
  subset = !str_detect(study, "Peters"),
  prediction = TRUE,
  allstudies = TRUE
)
...
<caption_mg> `r figure_ref()` Sensitivity root canal filled teeth (excludes Peters 1994). </caption_mg>
...
png("assets/meta_sens_root_canal_no_peters.png", width = 10.5, height = 7.5, units = "in", res = 300)
meta::forest(meta_sens_no_peters,
  leftlabs = c("", "TP", "TP+FN"),
  rightlabs = c("Sensitivity", "95% CI"),
  print.tau2 = FALSE,
  print.tau = TRUE,
...
trim_image("meta_sens_root_canal_no_peters.png")
...
```{r forest_root_canal_filled_sens_no_peters}}
#| echo: false
#| include: false
...
```
![](assets/meta_sens_root_canal_no_peters.png){fig.align="left" width="55%"}
